...
backdoor_100 <-  loadResultsFile("exp_traffic_20191203-104619.txt")
backdoor_50 <-loadResultsFile("exp_traffic_20191203-142902.txt")
backdoor_25 <-loadResultsFile("exp_traffic_20191203-164352.txt")
