...
backdoor_4_1_first <- loadResultsFile("exp_yale_20200317-111217.txt")
backdoor_9_1_first <- loadResultsFile("exp_yale_20200321-091703.txt")
backdoor_4_1_last <- loadResultsFile("exp_yale_20200317-095227.txt")
backdoor_9_1_last <- loadResultsFile("exp_yale_20200321-102415.txt")
...
"BACKDOORS 9/1"
"BACKDOORS LAST 9/1"
in_between_normal <- backdoor_9_1_last$X7[backdoor_9_1_last$X1=="normal"]
in_between_backdoor <- backdoor_9_1_last$X6[backdoor_9_1_last$X1=="backdoor"]

after_normal <- backdoor_9_1_last$X9[backdoor_9_1_last$X1=="normal"]
after_backdoor <- backdoor_9_1_last$X9[backdoor_9_1_last$X1=="backdoor"]
...
"BACKDOORS FIRST 9/1"
in_between_normal <- backdoor_9_1_first$X6[backdoor_9_1_first$X1=="normal"]
in_between_backdoor <- backdoor_9_1_first$X7[backdoor_9_1_first$X1=="backdoor"]

after_normal <- backdoor_9_1_first$X9[backdoor_9_1_first$X1=="normal"]
after_backdoor <- backdoor_9_1_first$X9[backdoor_9_1_first$X1=="backdoor"]
