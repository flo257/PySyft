...
clients_9_1_green_1_100 <- loadResultsFile("exp_gtsrb_20200318-203814.txt")
clients_8_2_green_1_100 <- loadResultsFile("exp_gtsrb_20200319-161053.txt")
clients_7_3_green_1_100 <- loadResultsFile("exp_gtsrb_20200319-173620.txt")
